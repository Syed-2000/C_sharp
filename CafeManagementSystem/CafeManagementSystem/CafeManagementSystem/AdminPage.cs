...
namespace CafeManagementSystem
{
    class AdminPage
    {
        ...
        {
            string path = @"C:\Users\osama\Desktop\Csharp\ManagementSystemsOnConsole\CafeManagementSystem\CafeManagementSystem\TxtFiles\Items.txt";
        ...
        {
            Console.Clear();
            string path = @"C:\Users\osama\Desktop\Csharp\ManagementSystemsOnConsole\CafeManagementSystem\CafeManagementSystem\TxtFiles\Sold_Items.txt";
            string[] print = File.ReadAllLines(path, Encoding.UTF8);
        ...
        {
           string path2 = @"C:\Users\osama\Desktop\Csharp\ManagementSystemsOnConsole\CafeManagementSystem\CafeManagementSystem\TxtFiles\Items.txt";
           FileStream flesBN = new FileStream(path2, FileMode.Open, FileAccess.Read);
           StreamReader readBN = new StreamReader(flesBN);
           string[] all_linesBN = File.ReadAllLines(path2, Encoding.UTF8);
        ...
        public void searchByDate()
        {
            ...
            string way = @"C:\Users\osama\Desktop\Csharp\ManagementSystemsOnConsole\CafeManagementSystem\CafeManagementSystem\TxtFiles\sold_it.txt";
            string[] line = File.ReadAllLines(way, Encoding.UTF8);
            int c = 0;
